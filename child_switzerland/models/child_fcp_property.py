...
class TranslateProperty(models.AbstractModel):
    ...
    value_fr = fields.Char(
        "French value",
        compute="_compute_value_fr",
        inverse="_inverse_value_fr"
    )
    value_it = fields.Char(
        "Italian value",
        compute="_compute_value_it",
        inverse="_inverse_value_it"
    )
    value_de = fields.Char(
        "German value",
        compute="_compute_value_de",
        inverse="_inverse_value_de"
    )
