...
class B2sControllerSwitzerland(RestController):
    ...
    def handler_b2s_image(self, id=None, disp=None, type=None):
        """
        ...
        :param disp: "inline" to show in browser or None to download.
        :param type: can force to use the PDF even though stored as ZIP.
        :return: file data for user
        """
        res = super().handler_b2s_image(id, disp, type)
