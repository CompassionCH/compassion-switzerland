...
class OnboardingController(Controller):
    ...
    def onboarding_unsubscribe(
        self, onboarding_type, onboarding_hash, confirm_opt_out=False, **kwargs
    ):
        if onboarding_type == "new_donors":
            return self._new_donors_onboarding_unsubscribe(
    ...
    def _new_donors_onboarding_unsubscribe(self, onboarding_hash, confirm_opt_out):
        partner = (
            ...
            .sudo()
            .search([("onboarding_new_donor_hash", "=", onboarding_hash)])
        )
