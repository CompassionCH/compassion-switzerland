...
class RestController(http.Controller):
    ...
    def sms_notification(self, **parameters):
        #...base url...?instance=pro&sender=%2B244342126&operator=orange&service=ULTIMATE&language=fr
        # &command=FORWARD&receptionDate=2014-04-12+12%3A00%3A00.000&requestUid=sms21342314
        #&text=COMPASSION
    ...
    def sms_delivery_status(self, **parameters):
        # ?requestUid=xml9677321&sentMessageUid=sms824762&receiver=%2B33612345678&operator=orange&service=ULTIMATE&status=delivered
