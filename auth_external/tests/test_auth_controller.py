...
class TestAuthController(HttpCase):
    ...
    def gen_expired_JWT(
        self, user_id: int, JWT_audience: str, signing_key: bytes
    ) -> str:
        delta = timedelta(
            seconds=-1
        ...
        self.user_2fa = res_users.create(
            {
                **test_user,
                ...
                # v18: `totp_enabled` is computed from totp_secret; we
                # don't (and shouldn't) write to it directly.
            }
        )
    ...
    def assert_refresh_token_reuse_detection_triggered(
        ...
        self.assertIn(
            "error",
            body,
            f"Expected JSON-RPC error envelope, got: {body!r}",
        )
        self.assertEqual(
    ...
    def user_normal_login(self) -> LoginRespData:
    ...
    def user_2fa_login(self) -> LoginRespData:
    ...
    def test_fresh_access_token_is_accepted(self):
        ...
        """
        user_id, access_token, _, _ = self.user_normal_login()
    ...
    def test_can_refresh_access_token_with_valid_refresh_token(self):
        ...
        """
        user_id, access_token, refresh_token, _ = self.user_normal_login()
    ...
    def test_refresh_token_reuse_detection_mechanism_works(self):
        ...
        """
        _, _, rt1, _ = self.user_normal_login()
    ...
    def test_full_2fa_user_lifecycle(self):
        # First, they login
        uid, at1, rt1, _ = self.user_2fa_login()
