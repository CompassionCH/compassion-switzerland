...
class LargePictureForm(models.AbstractModel):
    ...
    _form_model_fields = ["picture_large"]
    _form_required_fields = ["picture_large"]
    ...
    def form_widgets(self):
        ...
        res["picture_large"] = "cms_form_compassion.form.widget.simple.image"
        return res
    ...
    #     #     image.seek(0)
    #     if image:
    #         self.request.session[fname] = image
    #     else:
