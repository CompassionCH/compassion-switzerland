...
class PaymentAcquirerOgone(models.Model):
    ...
    def ogone_form_generate_values(self, values):
        ...
        temp_ogone_tx_values = {
            ...
            "ACCEPTURL": "%s" % urlparse.urljoin(base_url, OgoneCompassion._accept_url),
            "DECLINEURL": "%s"
            % urlparse.urljoin(base_url, OgoneCompassion._decline_url),
            "EXCEPTIONURL": "%s"
            % urlparse.urljoin(base_url, OgoneCompassion._exception_url),
            "CANCELURL": "%s" % urlparse.urljoin(base_url, OgoneCompassion._cancel_url),
