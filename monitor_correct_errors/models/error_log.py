...
class ErrorsLog(models.Model):
    ...
    error_type = fields.Selection(
        [
            ...
            ("Letters scanned in for too long", "Letters scanned in for too long"),
            ("Sponsored child has no sponsor", "Sponsored child has no sponsor"),
        ]
    )
    ...
    def format_record_url(self):
        ...
        url = (
            f'<a href="{base_url}/web#id={self.record_id}'
    ...
    def format_action_url(self):
        ...
        url = (
            f'<a href="{base_url}/web#id={self.action_id}'
