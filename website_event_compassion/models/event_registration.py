...
class Event(models.Model):
    ...
    def _compute_sponsorship_url(self):
        ...
        for registration in self:
            ...
            registration.survival_sponsorship_url = wp_obj.host + wp_obj.survival_sponsorship_url
    ...
    def _compute_stage_tasks(self):
        for registration in self:
            ...
            registration.complete_stage_task_ids = registration.completed_task_ids \
                .filtered(lambda t: t.stage_id == registration.stage_id)
